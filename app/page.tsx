...
const translations: Record<string, { en: string; zh: string }> = {
  ...
  "TABLETOP SEM": { en: "TABLETOP SEM", zh: "台式扫描电子显微镜" },
  "ADVANCED SEM": { en: "ADVANCED SEM", zh: "高级扫描电子显微镜" },
  "HIGH PERFORMANCE SEM": { en: "HIGH PERFORMANCE SEM", zh: "高性能扫描电子显微镜" },
  ...
  "TEM-STM Integrated Force": { en: "TEM-STM Integrated Force", zh: "TEM-STM Integrated Force" },
  "TEM-STM Electrical": { en: "TEM-STM Electrical", zh: "TEM-STM Electrical" },
  "MEMS Atmosphere Heating": { en: "MEMS Atmosphere Heating", zh: "MEMS Atmosphere Heating" },
  "MEMS Liquid Electrochemical": { en: "MEMS Liquid Electrochemical", zh: "MEMS Liquid Electrochemical" },
  "MEMS Low Temperature Electrical": { en: "MEMS Low Temperature Electrical", zh: "MEMS Low Temperature Electrical" },
  "MEMS Heated Electrical": { en: "MEMS Heated Electrical", zh: "MEMS Heated Electrical" },
  "Stretching": { en: "Stretching", zh: "Stretching" },
  "360° Horizontal Rotating": { en: "360° Horizontal Rotating", zh: "360° Horizontal Rotating" },
  "Frozen": { en: "Frozen", zh: "Frozen" },
  "Vacuum Transfer": { en: "Vacuum Transfer", zh: "Vacuum Transfer" },
  "Multi-well": { en: "Multi-well", zh: "Multi-well" },
  "High Temperature Mechanical": { en: "High Temperature Mechanical", zh: "High Temperature Mechanical" },
  "TEM Photoelectric Property Testing": { en: "TEM Photoelectric Property Testing", zh: "TEM Photoelectric Property Testing" },
  "TEM Cryo-electrical Test": { en: "TEM Cryo-electrical Test", zh: "TEM Cryo-electrical Test" },
  "TEM Mechanical-Electrical": { en: "TEM Mechanical-Electrical", zh: "TEM Mechanical-Electrical" },
};
