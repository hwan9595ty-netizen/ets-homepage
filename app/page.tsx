...
const dataTranslations: Record<string, { en: string; zh: string }> = {
  // Main cards / categories
  "주사전자현미경": { en: "Scanning Electron Microscope", zh: "扫描电子显微镜" },
  "SCANNING ELECTRON MICROSCOPE": { en: "SCANNING ELECTRON MICROSCOPE", zh: "扫描电子显微镜" },
  "3개의 Table Top SEM, 1개의 Normal SEM 제품 라인업": { en: "Lineup of 3 Table Top SEMs and 1 Normal SEM", zh: "3款台式SEM和1款普通SEM产品阵容" },
  "IN-SITU TEM/SEM SOLUTIONS": { en: "IN-SITU TEM/SEM SOLUTIONS", zh: "原位 TEM/SEM 解决方案" },
  "IN-SITU TEM / SEM SOLUTIONS": { en: "IN-SITU TEM / SEM SOLUTIONS", zh: "原位 TEM / SEM 解决方案" },
  "In-situ 분석 및 특수 응용을 위한 TEM/SEM 솔루션 라인업": { en: "TEM/SEM solution lineup for in-situ analysis and special applications", zh: "用于原位分析及特殊应用的 TEM/SEM 解决方案产品线" },
  "PRODUCTS INTRODUCTION": { en: "PRODUCTS INTRODUCTION", zh: "产品介绍" },
  "SAMPLE PREPARATION": { en: "SAMPLE PREPARATION", zh: "样品制备" },
  ...
  "컴팩트한 설계와 안정적인 관찰 성능을 제공하는 주사전자현미경입니다.": { en: "A scanning electron microscope that provides compact design and stable observation performance.", zh: "具备紧凑设计与稳定观察性能的扫描电子显微镜。" },
  ...
  "분석 옵션과 사용자 편의성을 강화한 주사전자현미경 모델입니다.": { en: "A scanning electron microscope model with enhanced analysis options and user convenience.", zh: "加强了分析选项与用户便利性的扫描电子显微镜型号。" },
  ...
  "고속 진공 펌핑: 90초 만에 진공 펌핑을 완료하여 작업 효율을 향상시킵니다.": { en: "High-speed vacuum pumping: completes vacuum pumping in 90 seconds to improve work efficiency.", zh: "高速抽真空：90秒内完成抽真空，提高工作效率。" },
  "부드러운 영상: 빠른 영상 속도, 고스팅이나 번짐 없음, 샘플 디테일을 명확히 보여줍니다.": { en: "Smooth imaging: fast image speed with no ghosting or smearing, clearly showing sample details.", zh: "图像流畅：成像速度快，无重影或拖影，清晰呈现样品细节。" },
  "가속 전압: 3-18kV까지 1kV 단위로 연속적으로 조절되어 유연한 전압 옵션을 제공합니다.": { en: "Accelerating voltage: continuously adjustable from 3–18 kV in 1 kV steps for flexible voltage options.", zh: "加速电压：3–18kV 可按 1kV 步进连续调节，提供灵活电压选择。" },
  "다양한 신호: 조성 및 형태 분석을 위한 선택적 SE, BSE, EDS 신호 검출기가 제공됩니다.": { en: "Various signals: optional SE, BSE, and EDS detectors are available for composition and morphology analysis.", zh: "多种信号：可选 SE、BSE、EDS 探测器，用于成分与形貌分析。" },
  "풍부한 확장성: 가열 단계, TEC 냉각 단계 등 자체 개발한 현장 SEM 액세서리와 호환되는 풍부한 현장 확장 기능을 제공합니다.": { en: "Rich expandability: compatible with self-developed in-situ SEM accessories such as heating stages and TEC cooling stages.", zh: "丰富扩展性：兼容自研原位 SEM 附件，如加热台、TEC冷却台等。" },
  "고성능 분석용 주사전자현미경 모델": { en: "High-performance scanning electron microscope for advanced analysis", zh: "高性能分析型扫描电子显微镜" },
  "정밀 관찰과 고해상도 분석에 적합한 고성능 주사전자현미경입니다.": { en: "A high-performance SEM suitable for precision observation and high-resolution analysis.", zh: "适用于精密观察与高分辨率分析的高性能扫描电子显微镜。" },
  "진공 분리 기술: 전자총과 샘플 챔버가 분리된 진공 설계를 사용하여 1분 이내에 샘플 변화를 가능하게 합니다.": { en: "Vacuum separation technology: separates the electron gun and sample chamber, enabling sample changes within one minute.", zh: "真空分离技术：电子枪与样品腔室分离设计，可在1分钟内更换样品。" },
  ...
  "초고해상도: 최대 360,000배 배율, 5nm 해상도, 20kV 해상도를 달성합니다.": { en: "Ultra-high resolution: achieves up to 360,000x magnification and 5 nm resolution at 20 kV.", zh: "超高分辨率：最高360,000倍放大，20kV下可达5nm分辨率。" },
  "표준 감속 모드: 금이 튀지 않고 약전도성 샘플을 관찰할 수 있습니다.": { en: "Standard deceleration mode: enables observation of weakly conductive samples without gold coating artifacts.", zh: "标准减速模式：可观察弱导电样品，减少金喷镀影响。" },
  "인챔버 카메라: 샘플 챔버에는 현장 실험 중 시료 변화를 실시간으로 모니터링할 수 있는 고화질 카메라가 장착되어 있습니다.": { en: "In-chamber camera: a high-definition camera monitors sample changes in real time during in-situ experiments.", zh: "腔室内相机：配备高清相机，可在原位实验中实时监测样品变化。" },
  ...
  "뛰어난 비용 효율성": { en: "Excellent Cost Efficiency", zh: "出色的成本效益" },
  "균일 코팅": { en: "Uniform Coating", zh: "均匀镀膜" },
  "전처리 품질 향상": { en: "Improved Pretreatment Quality", zh: "提升前处理质量" },
  "간편한 운용": { en: "Easy Operation", zh: "操作简便" },
  "다양한 시편 대응": { en: "Supports Various Samples", zh: "适用于多种样品" },

  // Options / software / gallery
  "Ion spotter coater": { en: "Ion sputter coater", zh: "离子溅射镀膜仪" },
  ...
  "새롭게 적용된 신규 UI로 더욱 간편하게 촬영 환경을 설정해보세요.": { en: "Set up the imaging environment more easily with the newly applied UI.", zh: "通过全新UI，更轻松地设置拍摄环境。" },
  "최적의 접근성으로 기존 소프트웨어 대비 60% 더 빠른 결과물을 확인할 수 있습니다.": { en: "With optimized accessibility, you can review results up to 60% faster than with previous software.", zh: "借助优化后的易用性，结果确认速度比原有软件快60%。" },
  ...
  "주요 촬영 조건과 장비 상태를 한 화면에서 빠르게 확인할 수 있습니다.": { en: "Quickly check key imaging conditions and equipment status on one screen.", zh: "可在一个界面中快速查看主要拍摄条件和设备状态。" },
  ...
  "초보 사용자도 쉽게 적응할 수 있도록 화면 구성을 단순하고 명확하게 개선했습니다.": { en: "The layout has been simplified and clarified so even new users can adapt easily.", zh: "为了让初学者也能轻松上手，界面布局更加简洁清晰。" },
...
const temNameTranslations: Record<string, { en: string; zh: string }> = {
  "MEMS-TEM-STM Multi-Field": { en: "MEMS-TEM-STM Multi-Field", zh: "MEMS-TEM-STM 多场测量系统" },
  "High-Temperature Mechanics": { en: "High-Temperature Mechanics", zh: "高温力学测量系统" },
  "TEM-STM Low Temperature Electrical": { en: "TEM-STM Low Temperature Electrical", zh: "TEM-STM 低温电学测量系统" },
  "TEM-STM Photoelectric Integrated": { en: "TEM-STM Photoelectric Integrated", zh: "TEM-STM 光电一体化系统" },
  "TEM-STM Integrated Force": { en: "TEM-STM Integrated Force", zh: "TEM-STM 力学一体化系统" },
  "TEM-STM Electrical": { en: "TEM-STM Electrical", zh: "TEM-STM 电学测量系统" },
  "MEMS Atmosphere Heating": { en: "MEMS Atmosphere Heating", zh: "MEMS 气氛加热系统" },
  "MEMS Liquid Electrochemical": { en: "MEMS Liquid Electrochemical", zh: "MEMS 液体电化学系统" },
  "MEMS Low Temperature Electrical": { en: "MEMS Low Temperature Electrical", zh: "MEMS 低温电学系统" },
  "MEMS Heated Electrical": { en: "MEMS Heated Electrical", zh: "MEMS 加热电学系统" },
  "Stretching": { en: "Stretching", zh: "拉伸测试系统" },
  "360° Horizontal Rotating": { en: "360° Horizontal Rotating", zh: "360° 水平旋转系统" },
  "Frozen": { en: "Cryogenic System", zh: "低温冷冻系统" },
  "Vacuum Transfer": { en: "Vacuum Transfer", zh: "真空转移系统" },
  "Multi-well": { en: "Multi-well", zh: "多孔位系统" },
  "High Temperature Mechanical": { en: "High Temperature Mechanical", zh: "高温机械系统" },
  "TEM Photoelectric Property Testing": { en: "TEM Photoelectric Property Testing", zh: "TEM 光电性能测试系统" },
  "TEM Cryo-electrical Test": { en: "TEM Cryo-electrical Test", zh: "TEM 低温电学测试系统" },
  "TEM Mechanical-Electrical": { en: "TEM Mechanical-Electrical", zh: "TEM 机电耦合测试系统" },
};

const longTranslations: Map<string, { en: string; zh: string }> = new Map(Object.entries({
  "PicoFemto 현장 MEMS-TEM-STM 다중장 측정 시스템(PicoFemto) 현장 투과 전자 현미경 실험 시스템으로, 연구자들이 투과 전자현미경 내에서 제어된 다장 환경을 구축하여 다중 여기 하에서 재료나 장치 등 시료를 현장 특성화할 수 있도록 합니다.": { en: "The PicoFemto in-situ MEMS-TEM-STM multi-field measurement system enables researchers to build a controlled multi-field environment inside a TEM, allowing in-situ characterization of materials or devices under multiple excitations.", zh: "PicoFemto 原位 MEMS-TEM-STM 多场测量系统可在 TEM 内构建受控多场环境，实现多激励条件下对材料或器件的原位表征。" },
  "PicoFemto 현장 TEM 고온 역학 측정 시스템은 기계적 측정 모듈과 MEMS 칩 모듈을 통합하여 시료를 최대 1000 °C까지 가열하는 동안 정량적 기계적 측정을 수행할 수 있습니다. MEMS 칩 모듈은 가열 칩 또는 전기 측정 칩 중 선택할 수 있습니다. 기계적 측정 모듈은 다양한 실험 요구에 맞게 다양한 부하 센서를 선택할 수 있습니다.": { en: "The PicoFemto in-situ TEM high-temperature mechanical measurement system integrates a mechanical module and a MEMS chip module, enabling quantitative mechanical measurements while heating samples up to 1000 °C. Users can select heating or electrical chips and load sensors according to experimental needs.", zh: "PicoFemto 原位 TEM 高温力学测量系统集成机械测量模块与 MEMS 芯片模块，可在样品加热至 1000°C 时进行定量力学测量，并可根据实验需求选择加热/电学芯片与负载传感器。" },
  "피코펨토 인사이트(현장) TEM TEM-STM 저온 전기 측정 시스템은 표준 형태의 투과형 전자현미경 시료 막대로, 스캐닝 프로브 제어 장치를 갖추고 프로브를 통해 개별 나노구조와 전기 측정을 동시에 조작하며, 시료의 결정 구조, 화학 성분, 원소 원자에 대한 동적 고해상도 종합 특성 분석이 가능합니다. 투과의 기능과 응용 분야를 크게 확장하여 투과 전자현미경의 기능과 응용 분야를 크게 확장합니다.": { en: "The PicoFemto in-situ TEM-STM low-temperature electrical measurement system is a standard TEM holder equipped with scanning probe control, enabling manipulation of individual nanostructures and electrical measurements with high-resolution dynamic characterization.", zh: "PicoFemto 原位 TEM-STM 低温电学测量系统为标准 TEM 样品杆，配备扫描探针控制装置，可对单个纳米结构进行操控并同步开展电学测量与高分辨动态表征。" },
  "PicoFemto in-situ TEM TEM-STM 광전 통합 측정 시스템은 표준 형태 투과형 전자 현미경 시료봉으로, 주사 프로브 제어 장치를 갖추고 프로브를 통해 개별 나노구조와 전기적 측정, 그리고 동시에 전기 측정을 조작합니다. 시료의 결정 구조, 화학 성분, 원소 원자에 대한 동적 고해상도 종합 특성화를 제공하여 기능과 응용을 크게 확장합니다 투과 영역 이로 인해 투과 전자현미경의 기능과 응용 분야가 크게 확장됩니다.": { en: "The PicoFemto in-situ TEM-STM photoelectric integrated system is a standard TEM holder with scanning probe control, enabling nanostructure manipulation together with electrical and photoelectric measurements inside TEM.", zh: "PicoFemto 原位 TEM-STM 光电一体化系统为标准 TEM 样品杆，配备扫描探针控制，可在 TEM 内实现纳米结构操控、电学与光电测量。" },
  "PicoFemto in-Situ TEM TEM-STM 통합 힘 측정 시스템은 TEM 시료봉의 표준 형태에 추가된 스캐닝 프로브 제어 장치로, 프로브를 통해 개별 나노구조와 전기적 측정을 조작할 수 있으며, 동시에 전기 측정도 수행할 수 있습니다. 시료의 결정 구조, 화학 성분, 원소 원자에 대한 동적 고해상도 종합 특성 분석이 가능합니다. TEM의 기능과 응용 분야를 크게 확장했습니다. 이로 인해 투과 전자현미경의 기능과 응용 분야가 크게 확장되었습니다.": { en: "The PicoFemto in-situ TEM-STM integrated force measurement system adds scanning probe control to a standard TEM holder, enabling nanostructure manipulation, electrical measurements, and dynamic high-resolution characterization.", zh: "PicoFemto 原位 TEM-STM 力学一体化测量系统在标准 TEM 样品杆基础上加入扫描探针控制，可实现纳米结构操控、电学测量与动态高分辨综合表征。" },
  "현장 TEM TEM-STM 전기 측정 시스템은 투과 전자현미경(TEM)과 주사 터널링 현미경(STM)의 기능을 통합한 고급 과학 연구 장비로, 나노 스케일에서 재료의 전기적 특성 연구를 위해 설계되었습니다. 이 시스템은 TEM 환경에서 현장 전기 측정, 구조 영상 및 기계적 조절의 조정 작동을 지원하며, 저차원 재료, 이종접합, 양자 소자, 인터페이스 현상과 같은 고급 주제 연구에 널리 사용되고 있습니다.": { en: "The in-situ TEM-STM electrical measurement system integrates TEM and STM functions for nanoscale electrical property research, supporting in-situ electrical testing, structural imaging, and mechanical adjustment inside TEM.", zh: "原位 TEM-STM 电学测量系统集成 TEM 与 STM 功能，用于纳米尺度材料电学性质研究，支持 TEM 环境下的原位电学测量、结构成像与机械调控。" },
  "PicoFemto 현장 TEM MEMS 대기 가열 측정 시스템은 투과 전자현미경에서 대기와 고온 환경을 생성하며, 1 Bar 및 800 °C의 종단 간 관측 조건을 실현합니다. 이 시스템은 연구자들이 촉매 반응, 산화환원 반응, 저차원 재료 성장/합성, 다양한 부식 반응을 원자 규모에서 실시간으로 관찰할 수 있게 해주며, TEM을 정적 영상 도구에서 강력한 나노랩으로 업그레이드할 수 있게 합니다.": { en: "The PicoFemto in-situ TEM MEMS atmosphere heating system creates gas and high-temperature environments in TEM, enabling observation at up to 1 bar and 800 °C for reactions, growth, synthesis, and corrosion studies.", zh: "PicoFemto 原位 TEM MEMS 气氛加热系统可在 TEM 中构建气氛与高温环境，实现最高 1 Bar、800°C 条件下的实时原子尺度观察。" },
  "피코펨토 현장 TEM MEMS 액체 전기화학 측정 시스템은 액체 캡슐화를 용이하게 하는 새로운 O-링 보조 씰 설계를 특징으로 합니다. 실험에서는 샘플을 초박 질소 실리콘 필름으로 덮은 액체 셀 안에 밀봉하는데, 이 필름은 1기압을 견딜 수 있습니다. 칩 전극은 외부 회로에 연결되어 전자현미경 내에서 액체-전기화학 시험 환경을 구축합니다.": { en: "The PicoFemto in-situ TEM MEMS liquid electrochemical system uses an O-ring assisted sealing design for liquid encapsulation, creating a liquid-electrochemical test environment inside the microscope.", zh: "PicoFemto 原位 TEM MEMS 液体电化学系统采用 O 形圈辅助密封设计，便于液体封装，并在电镜内构建液体-电化学测试环境。" },
  "피코펨토 현장 TEM MEMS 저온 전기 측정 시스템은 표준 MEMS 칩 샘플 로드에 통합된 극저온 제어 모듈로, 극저온 전기 측정 또는 전온 측정 기능을 구현합니다.": { en: "The PicoFemto in-situ TEM MEMS low-temperature electrical system integrates a cryogenic control module into a standard MEMS chip holder for low-temperature electrical measurements.", zh: "PicoFemto 原位 TEM MEMS 低温电学系统将低温控制模块集成到标准 MEMS 芯片样品杆中，实现低温电学测量。" },
  "PicoFemto 현장 TEM MEMS 가열 전기 측정 시스템, 투과 전자현미경은 고시간 해상도로 원자 수준의 공간 해상도를 얻을 수 있는 실험 도구입니다. 투과 전자현미경 현장 가열/전기 측정 시스템은 MEMS 마이크로 가열 칩과 표준 형태의 투과 전자현미경 샘플 막대 안에 장착된 전기 측정 칩으로 구성됩니다. 마이크로 가열 칩은 시료를 제어된 온도로 가열할 수 있고, 전기 측정 칩은 시료의 전기적 특성을 측정할 수 있습니다. 가열과 전기 측정 시점에 시료의 결정 구조, 화학 성분 및 원소 원자 상태를 동적이고 높은 해상도로 특성화할 수 있어 투과 전자현미경의 기능과 응용 분야가 크게 확장됩니다.": { en: "The PicoFemto in-situ TEM MEMS heating electrical system combines MEMS micro-heating chips with electrical measurement chips to heat samples and measure electrical properties while dynamically characterizing structure and composition at high resolution.", zh: "PicoFemto 原位 TEM MEMS 加热电学系统结合 MEMS 微加热芯片与电学测量芯片，可在加热过程中同步测量电学性质并进行高分辨动态表征。" },
  "피코펨토 현장 TEM 신장 측정 시스템은 투과 전자현미경을 통한 재료 구조 변화를 현장 관찰과 함께 실온에서 재료에 인장력을 가할 수 있게 합니다. 이 시스템은 단일 경사진 신장 시료 막대, 신장 컨트롤러, 특수 신장 시료 운반 시트를 포함합니다. 응용 방향: 금속 재료, 나노재료, 박막 등의 기계적 변화 메커니즘을 연구합니다.": { en: "The PicoFemto in-situ TEM stretching system applies tensile force at room temperature while observing structural changes in TEM, supporting mechanical mechanism studies of metals, nanomaterials, and thin films.", zh: "PicoFemto 原位 TEM 拉伸系统可在室温下施加拉伸力并在 TEM 中观察结构变化，适用于金属、纳米材料和薄膜的力学机制研究。" },
  "피코펨토인 제자리 TEM 360° 수평 회전 측정 시스템은 β각 기울기와 360° 수평 회전을 모두 갖추고 있어 투과전자 현미경에서 다자유도, 고정밀 시료 회전을 가능하게 합니다.": { en: "The PicoFemto in-situ TEM 360° horizontal rotation system provides β-tilt and full 360° rotation for high-precision multi-degree sample rotation in TEM.", zh: "PicoFemto 原位 TEM 360° 水平旋转系统同时具备 β 角倾转与 360° 水平旋转能力，实现高精度多自由度样品旋转。" },
  "현장 TEM 냉동 측정 시스템은 재료 과학, 구조생물학, 나노기술과 같은 최첨단 분야를 위해 설계된 고정밀 저온 동적 관측 장치입니다. 이 시스템은 고해상도 투과 전자현미경(TEM)과 연동되어 초저온 조건에서 시료의 구조, 형태, 동적 진화를 실시간으로 현장에서 관찰할 수 있습니다. 저온 민감 시료의 미시적 거동을 분석하는 데 필수적인 연구 도구입니다.": { en: "The in-situ TEM cryogenic measurement system is a high-precision low-temperature dynamic observation device for materials science, structural biology, and nanotechnology, enabling real-time observation under cryogenic conditions.", zh: "原位 TEM 低温冷冻测量系统是面向材料科学、结构生物学和纳米技术的高精度低温动态观察装置，可在超低温条件下实时观察样品结构与演化。" },
  "피코펨토 현장 TEM 진공 전달 측정 시스템은 진공 챔버나 글러브 박스에서 투과 전자현미경으로 샘플을 이동할 수 있도록 수납식 극단을 갖추도록 설계되어 대기 환경에 영향을 받지 않습니다.": { en: "The PicoFemto in-situ TEM vacuum transfer system uses a retractable tip design to transfer samples from vacuum chambers or glove boxes to TEM without exposure to air.", zh: "PicoFemto 原位 TEM 真空转移系统采用可伸缩端部设计，可将样品从真空腔或手套箱转移至 TEM，避免大气环境影响。" },
  "PicoFemto 현장 TEM 다중 웰 측정 시스템, 다공 샘플 바는 연구자가 최대 세 개의 샘플을 투과 전자현미경에 동시에 배치할 수 있게 하여 투과 전자현미경 사용 효율을 크게 향상시킵니다. 이 제품은 각 샘플을 양방향으로 독립적으로 기울일 수 있는 이중 틸트 버전으로도 제공됩니다.": { en: "The PicoFemto in-situ TEM multi-well system allows up to three samples to be placed in TEM simultaneously, greatly improving TEM usage efficiency. A double-tilt version is also available.", zh: "PicoFemto 原位 TEM 多孔位系统可同时放置最多三个样品，大幅提升 TEM 使用效率，并可提供各样品独立双向倾转版本。" },
  "피코펨토 현장 TEM 고온 기계적 측정 시스템(정량적 힘 + 전기 + 3D 조작 + 가열)은 기계적 측정 모듈과 MEMS 칩 모듈을 동시에 통합하여 시료를 1000°C에서 가열하면서 정량적 기계적 측정을 수행할 수 있습니다. 이는 진정한 의미의 투과 전자현미경에서 고해상도 정량적 현장 기계 연구를 실현합니다. 기계식 센서 표시기.": { en: "The PicoFemto in-situ TEM high-temperature mechanical system integrates quantitative force, electrical measurement, 3D manipulation, and heating to perform mechanical measurements at up to 1000°C inside TEM.", zh: "PicoFemto 原位 TEM 高温机械测量系统集成定量力、电学、3D 操作与加热功能，可在 1000°C 条件下进行 TEM 内定量力学研究。" },
  "PicoFemto 현장 MEMS-TEM-STM 다중장 측정 시스템(비정량적 힘 + 전기 + 빛 + 가열)은 혁신적인 현장 투과 전자 현미경 실험 시스템으로, 연구자들이 투과 전자현미경에서 제어된 다장 환경(힘, 열, 빛, 전기 등)을 구축하여 다중 여기 하에서 재료나 장치 등의 현장 특성화를 달성할 수 있게 합니다.": { en: "The PicoFemto in-situ MEMS-TEM-STM multi-field system integrates force, electricity, light, and heating, enabling controlled multi-field environments in TEM for in-situ characterization under multiple excitations.", zh: "PicoFemto 原位 MEMS-TEM-STM 多场系统集成力、电、光、加热等功能，可在 TEM 内构建受控多场环境，实现多激励原位表征。" },
  "피코펨투인-제자리 TEM 광전 특성 시험 시스템(비정량적 힘 + 전기 + 빛 + 3차원 조작)은 표준 TEM-STM 시료봉 내에 광섬유 장치를 통합하여 외부 분광기 또는 레이저와 함께 사용하여 광전자 측정 또는 CL 측정을 수행합니다.": { en: "The PicoFemto in-situ TEM photoelectric property testing system integrates optical fiber into a standard TEM-STM holder for photoelectric or CL measurements with external spectrometers or lasers.", zh: "PicoFemto 原位 TEM 光电性能测试系统将光纤集成到标准 TEM-STM 样品杆中，可配合外部分光仪或激光器进行光电或 CL 测量。" },
  "피코펨토 현장 TEM 저온전기 시험 시스템(비정량적 힘 + 전기 + 극저온 + 3D 조작)은 표준 TEM-STM 시료봉 내에 극저온 환경 제어 장치를 통합하여, 투과 전자현미경에서 현장 냉동 전기 측정의 목적을 실현합니다.": { en: "The PicoFemto in-situ TEM cryo-electrical test system integrates cryogenic control into a standard TEM-STM holder to realize in-situ low-temperature electrical measurements in TEM.", zh: "PicoFemto 原位 TEM 低温电学测试系统将低温环境控制装置集成到标准 TEM-STM 样品杆中，实现 TEM 内原位低温电学测量。" },
  "PicoFemto 현장 TEM 기계-전기 측정 시스템(정량적 힘 + 전기 + 3D 조작)은 표준 TEM-STM 샘플 로드 내에 나노 힘 센서를 통합하여 고정밀 기계 및 전기적 측정을 실현합니다.": { en: "The PicoFemto in-situ TEM mechanical-electrical system integrates a nano-force sensor into a standard TEM-STM holder, enabling high-precision mechanical and electrical measurements.", zh: "PicoFemto 原位 TEM 机电测量系统在标准 TEM-STM 样品杆中集成纳米力传感器，实现高精度力学与电学测量。" },

  // Brief descriptions
  "In-situ 실험 환경에서 시편의 구조 변화를 실시간으로 관찰할 수 있는 기본형 TEM/SEM 솔루션입니다.": { en: "A basic TEM/SEM solution for real-time observation of structural changes in samples under in-situ conditions.", zh: "可在原位实验环境下实时观察样品结构变化的基础型 TEM/SEM 解决方案。" },
  "가열 조건에서 미세 구조 변화를 추적하기에 적합한 In-situ 분석 장비입니다.": { en: "An in-situ analysis system suitable for tracking microstructural changes under heating conditions.", zh: "适合在加热条件下追踪微观结构变化的原位分析设备。" },
  "인장 및 변형 시험 중 시편 반응을 정밀하게 확인할 수 있는 모델입니다.": { en: "A model for precisely observing sample responses during tensile and deformation tests.", zh: "可在拉伸及变形试验中精确观察样品反应的型号。" },
  "냉각 조건에서 재료의 표면 및 내부 변화를 안정적으로 관찰할 수 있습니다.": { en: "Enables stable observation of surface and internal changes in materials under cooling conditions.", zh: "可在冷却条件下稳定观察材料表面及内部变化。" },
  "배터리, 반도체, 금속 소재 분석에 적합한 범용 In-situ TEM/SEM 시스템입니다.": { en: "A versatile in-situ TEM/SEM system suitable for batteries, semiconductors, and metallic materials.", zh: "适用于电池、半导体和金属材料分析的通用型原位 TEM/SEM 系统。" },
  "미세 구조의 시간에 따른 변화를 확인하기 위한 동적 분석용 장비입니다.": { en: "A dynamic analysis system for observing time-dependent microstructural changes.", zh: "用于观察微观结构随时间变化的动态分析设备。" },
  "복합 소재의 계면 변화와 결함 발생을 관찰하기 좋은 In-situ 분석 모델입니다.": { en: "An in-situ model well suited for observing interfacial changes and defect formation in composite materials.", zh: "适用于观察复合材料界面变化及缺陷产生的原位分析型号。" },
  "고배율 이미징과 실험 스테이지 연동이 가능한 연구용 솔루션입니다.": { en: "A research solution supporting high-magnification imaging and integration with experimental stages.", zh: "支持高倍率成像并可与实验台联动的研究型解决方案。" },
  "실험 중 샘플 반응을 직관적으로 파악할 수 있도록 설계된 In-situ 장비입니다.": { en: "An in-situ system designed for intuitive understanding of sample responses during experiments.", zh: "专为在实验中直观掌握样品反应而设计的原位设备。" },
  "열, 응력, 전기적 자극에 따른 구조 변화를 분석하는 데 적합한 모델입니다.": { en: "A model suitable for analyzing structural changes caused by heat, stress, and electrical stimulation.", zh: "适用于分析热、应力和电刺激引起的结构变化。" },
  "재료 개발 및 불량 분석 과정에서 활용하기 좋은 TEM/SEM 응용 장비입니다.": { en: "A TEM/SEM application system useful for material development and failure analysis.", zh: "适用于材料开发和失效分析的 TEM/SEM 应用设备。" },
  "연구실과 분석센터에서 폭넓게 사용할 수 있는 다목적 In-situ 솔루션입니다.": { en: "A multipurpose in-situ solution for laboratories and analytical centers.", zh: "可广泛应用于实验室和分析中心的多用途原位解决方案。" },
  "정밀 관찰과 반복 실험을 함께 고려한 안정형 TEM/SEM 장비입니다.": { en: "A stable TEM/SEM system designed for precise observation and repeated experiments.", zh: "兼顾精密观察与重复实验的稳定型 TEM/SEM 设备。" },
  "시편 반응을 실시간 이미지로 확보할 수 있는 고효율 분석 시스템입니다.": { en: "A high-efficiency analysis system for capturing sample responses in real time.", zh: "可实时获取样品反应图像的高效率分析系统。" },
  "다양한 In-situ 액세서리와 연동 가능한 확장형 TEM/SEM 솔루션입니다.": { en: "An expandable TEM/SEM solution compatible with various in-situ accessories.", zh: "可与多种原位附件联动的扩展型 TEM/SEM 解决方案。" },
  "나노 소재와 박막 샘플의 구조 변화를 세밀하게 관찰할 수 있는 장비입니다.": { en: "A system for detailed observation of structural changes in nanomaterials and thin films.", zh: "可细致观察纳米材料与薄膜样品结构变化的设备。" },
  "실험 조건 제어와 영상 확보를 동시에 중시하는 사용자에게 적합한 모델입니다.": { en: "Ideal for users who require both experimental condition control and image acquisition.", zh: "适合同时重视实验条件控制与图像获取的用户。" },
  "고급 응용 분석과 연구 데이터 확보를 위한 In-situ 전용 장비입니다.": { en: "A dedicated in-situ system for advanced application analysis and research data acquisition.", zh: "用于高级应用分析与研究数据获取的专用原位设备。" },
  "정확한 구조 해석과 반응 추적을 지원하는 고신뢰성 TEM/SEM 시스템입니다.": { en: "A highly reliable TEM/SEM system supporting accurate structural interpretation and response tracking.", zh: "支持精确结构解析与反应追踪的高可靠性 TEM/SEM 系统。" },
  "다양한 연구 환경에서 활용 가능한 통합형 In-situ TEM/SEM 솔루션입니다.": { en: "An integrated in-situ TEM/SEM solution usable in various research environments.", zh: "适用于多种研究环境的一体化原位 TEM/SEM 解决方案。" },

  // TEM features
  "높은 안정성": { en: "High Stability", zh: "高稳定性" },
  "긴 수명": { en: "Long Lifetime", zh: "长寿命" },
  "초저유지보수 비용": { en: "Ultra-low Maintenance Cost", zh: "超低维护成本" },
  "방대한 사용자 기반": { en: "Large User Base", zh: "庞大的用户基础" },
  " 매우 넓은 기계적 측정 및 온도 제어 범위": { en: "Very wide mechanical measurement and temperature control range", zh: "极宽的力学测量与温度控制范围" },
  "고안정성": { en: "High Stability", zh: "高稳定性" },
  "초장수명": { en: "Ultra-long Lifetime", zh: "超长寿命" },
  "여러 분야의 기계 연구": { en: "Mechanical research across multiple fields", zh: "适用于多领域力学研究" },
  "연속 온도 조절 가능, 높은 안정성": { en: "Continuous temperature control with high stability", zh: "可连续控温，稳定性高" },
  "저온은 시료와 전기적 연구에 가해지는 응력을 실현할 수 있습니다": { en: "Low temperature enables stress and electrical studies on samples", zh: "低温可实现样品应力与电学研究" },
  " 양방향 광섬유의 사용은 CL 분광학, 광전 검출, 전기발광 분광법 및 기타 연구에 적용될 수 있습니다": { en: "Bidirectional optical fibers support CL spectroscopy, photoelectric detection, and electroluminescence studies", zh: "双向光纤可用于 CL 光谱、光电检测、电致发光等研究" },
  " 고확장성을 가진 광 적분 솔루션": { en: "Highly expandable optical integration solution", zh: "高扩展性的光学集成方案" },
  "전자현미경의 원래 해상도를 보장하기 위한 높은 안정성": { en: "High stability to preserve the original resolution of the electron microscope", zh: "高稳定性，确保电子显微镜原有分辨率" },
  "전자 현미경의 원래 해상도를 보장하며, 구면 수차에서도 선명한 원자 이미지를 포착할 수 있습니다": { en: "Preserves the microscope’s original resolution and captures clear atomic images even with spherical aberration", zh: "保证电镜原有分辨率，即使存在球差也可获得清晰原子图像" },
  "우수한 기동 안정성, 압전 세라믹 구동 모드로 고정밀 기동을 보장합니다.": { en: "Excellent motion stability with piezoelectric ceramic drive for high-precision movement.", zh: "压电陶瓷驱动模式带来出色运动稳定性与高精度位移。" },
  "힘과 전기 통합 솔루션, 기계적 및 전기 구성으로 대부분의 시험 요구를 충족합니다": { en: "Integrated force and electrical solution meeting most mechanical and electrical testing requirements", zh: "力电一体化方案，可满足大部分机械与电学测试需求" },
  "조작이 쉽고, 친숙": { en: "Easy and user-friendly operation", zh: "操作简单，界面友好" },
  "TEM 진공과 호환": { en: "Compatible with TEM vacuum", zh: "兼容 TEM 真空环境" },
  "최소 100 nm 액체 전지 스페이서 두께": { en: "Minimum 100 nm liquid cell spacer thickness", zh: "最小 100 nm 液体池间隔层厚度" },
  "전압 출력 최대 ± 200 V, 최소 해상도 ± 100 nV": { en: "Voltage output up to ±200 V with minimum resolution of ±100 nV", zh: "电压输出最高 ±200 V，最小分辨率 ±100 nV" },
  ...
  "정밀 데이터": { en: "Precise Data", zh: "精密数据" },
  "전압 제어 분석": { en: "Voltage Control Analysis", zh: "电压控制分析" },
  "정밀 전기 분석": { en: "Precise Electrical Analysis", zh: "精密电学分析" },
  ...
  "연구 최적화": { en: "Research Optimization", zh: "研究优化" },
  ...
  "맞춤형 분석": { en: "Customized Analysis", zh: "定制化分析" },
  "다양한 환경": { en: "Various Environments", zh: "多种环境" },
  "확장성": { en: "Expandability", zh: "扩展性" },
}));

function normalizeDataText(text: string) {
  return text.replace(/\s+/g, ' ').replace(/[‐‑‒–—]/g, '-').trim();
}

function trData(text: string | undefined, lang: Lang): string {
  if (!text) return '';
  if (lang === 'ko') return text;
  const direct = dataTranslations[text] || temNameTranslations[text] || longTranslations.get(text);
  if (direct) return lang === 'en' ? direct.en : direct.zh;
  const normalized = normalizeDataText(text);
  for (const [key, value] of Object.entries(dataTranslations)) {
    if (normalizeDataText(key) === normalized) return lang === 'en' ? value.en : value.zh;
  }
  for (const [key, value] of Object.entries(temNameTranslations)) {
    if (normalizeDataText(key) === normalized) return lang === 'en' ? value.en : value.zh;
  }
  for (const [key, value] of longTranslations.entries()) {
    if (normalizeDataText(key) === normalized) return lang === 'en' ? value.en : value.zh;
  }
  return text;
}
        ...
        <table className="w-full border-separate border-spacing-0 overflow-hidden rounded-[24px] border border-[#2f7bc5]">
          <tbody>
            {specs.map((section, idx) => (
              <tr key={`${trData(section.group, lang)}-${idx}`}>
                ...
                <td className="whitespace-pre-line border-t border-[#7fb2df] bg-white px-4 py-4 text-[15px] leading-7 text-[#2f5f93] first:border-t-0">
                  {trData(section.rows[0]?.value, lang)}
                </td>
              </tr>
            ))}
          </tbody>
    ...
    <section className="rounded-[24px] border border-[#e5e7eb] bg-white p-6 shadow-[0_12px_32px_rgba(15,23,42,0.05)] lg:p-10">
      ...
      <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
        {options.map((item, idx) => (
          <div
            key={`${trData(item.title, lang)}-${idx}`}
          ...
          >
            ...
            <div className="mt-5">
              <h3 className="text-[20px] font-bold tracking-[-0.02em] text-[#111]">{trData(item.title, lang)}</h3>
              {item.subtitle ? (
                <p className="mt-2 text-[14px] leading-6 text-[#6b7280]">{trData(item.subtitle, lang)}</p>
              ) : (
    ...
    <section id="products" className="bg-[#08111b] px-4 py-14 md:px-6 md:py-16">
      <div className="mx-auto max-w-[1600px]">
        <div className="mb-8 px-2 text-center">
          <div className="text-[11px] font-medium tracking-[0.16em] text-white/50">{ui[lang].productLine}</div>
          <h2 className="mt-2 text-[28px] font-bold text-white lg:text-[40px]">{ui[lang].products}</h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {mainCategoryCards.map((item) => (
            <GridCard
              key={item.slug}
              title={trData(item.title, lang)}
              subtitle={trData(item.subtitle, lang)}
              description={<>{trData(item.description, lang)}</>}
              image={item.image}
            ...
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <div className="bg-[linear-gradient(180deg,#f7f9fc_0%,#eef2f6_100%)] px-5 pb-7 pt-5 sm:px-6 sm:pb-8 sm:pt-6">
                  ...
                  <div className="mt-3 text-[13px] text-[#5f6a78]">{trData(product.categoryLabel, lang)}</div>
                  <div className="mt-3 break-words text-[34px] font-bold leading-[0.95] tracking-[-0.04em] text-[#111] sm:text-[38px]">
                    {trData(product.title, lang)}
                  </div>
                  <div className="mt-4 min-h-[48px] text-[14px] leading-6 text-[#66707d]">{trData(product.description, lang)}</div>
        ...
        <div className="mx-auto max-w-[1280px] space-y-8">
          <section className="rounded-[24px] border border-[#e5e7eb] bg-white p-6 shadow-[0_12px_32px_rgba(15,23,42,0.05)] lg:p-10">
            <div className="text-[13px] font-semibold tracking-[0.12em] text-[#1457b5]">
              {trData(product.categoryLabel, lang)}
            </div>
              ...
              <div className="min-w-0 overflow-hidden">
                ...
                <div className="mt-8">
                  ...
                  <ul className="mt-4 space-y-3 break-words text-[15px] leading-7 text-[#444] sm:text-[16px]">
                    {product.features.map((item) => (
                      <li key={trData(item, lang)} className="flex gap-3">
                        <span className="mt-[10px] h-[6px] w-[6px] rounded-full bg-[#1457b5]" />
                        <span className="min-w-0 flex-1 break-words">{trData(item, lang)}</span>
                      </li>
                    ))}
                  </ul>
                </div>
                ...
                {product.briefInfo && !showSummaryInSpecArea ? (
                  <section className="mt-8 rounded-[20px] border border-[#dbe4f0] bg-[#f8fbff] p-5 lg:p-6">
                    ...
                    <p className="mt-3 text-[15px] leading-7 text-[#4b5563]">{trData(product.briefInfo, lang)}</p>
                  </section>
                ) : null}
            ...
            <section className="rounded-[24px] border border-[#e5e7eb] bg-white p-6 shadow-[0_12px_32px_rgba(15,23,42,0.05)] lg:p-10">
              ...
              <div className="mt-8 space-y-8">
                {product.gallery.slice(0, 10).map((item, idx) => (
                  <BeforeAfterSEM key={`${trData(item.title, lang)}-${idx}`} afterSrc={item.image} title={trData(item.title, lang)} lang={lang} />
                ))}
              </div>
            </section>
          ) : null}
          ...
          {showSummaryInSpecArea ? (
            <section className="rounded-[24px] border border-[#e5e7eb] bg-white p-6 shadow-[0_12px_32px_rgba(15,23,42,0.05)] lg:p-10">
              ...
              <p className="mt-4 max-w-[900px] text-[16px] leading-8 text-[#4b5563]">{trData(product.briefInfo, lang)}</p>
            </section>
          ) : null}
                        ...
                        <div className="flex items-end justify-between">
                          <div>
                            <div className="mb-1 text-[11px] font-semibold tracking-[0.16em] text-white/70">
                              {ui[lang].analysisImage ?? "ANALYSIS IMAGE"}
                            </div>
        ...
        <div className="mt-10 flex justify-center">
          <div className="flex w-full max-w-[700px] justify-between gap-10">
            <div className="flex flex-col items-center text-center">
              <div className="text-[18px] font-bold lg:text-[20px]">{ui[lang].footerSemTitle}</div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="text-[18px] font-bold lg:text-[20px]">{ui[lang].inquiry}</div>
              <p className="mt-4 text-[14px] leading-7 text-white/85">
                빠르고 정확하게
                <br />
                답변해 드립니다.
    ...
    <footer className="bg-black px-6 py-12 text-white lg:px-14 lg:py-16">
      <div className="mx-auto max-w-[1520px]">
        <div className="flex flex-wrap gap-10 border-b border-white/20 pb-10 text-[18px] font-semibold">
          <button className="transition hover:text-[#7fb2ff]">{ui[lang].company}</button>
          <button className="transition hover:text-[#7fb2ff]">{ui[lang].privacy}</button>
          <button className="transition hover:text-[#7fb2ff]">{ui[lang].directions}</button>
        </div>
